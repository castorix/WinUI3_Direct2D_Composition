...
namespace Direct2D
{
    ...
    public interface ID2D1Bitmap : ID2D1Image
    {
        ...
        HRESULT CopyFromBitmap(ref D2D1_POINT_2U destPoint, ID2D1Bitmap bitmap, D2D1_RECT_U srcRect);
        HRESULT CopyFromRenderTarget(ref D2D1_POINT_2U destPoint, ID2D1RenderTarget renderTarget, D2D1_RECT_U srcRect);
        HRESULT CopyFromMemory(ref D2D1_RECT_U dstRect, IntPtr srcData, uint pitch);
    }
    ...
    public interface ID2D1Bitmap1 : ID2D1Bitmap
    {
        ...
        new D2D1_PIXEL_FORMAT GetPixelFormat();
        new void GetDpi(out float dpiX, out float dpiY);
        new HRESULT CopyFromBitmap(ref D2D1_POINT_2U destPoint, ID2D1Bitmap bitmap, D2D1_RECT_U srcRect);
        new HRESULT CopyFromRenderTarget(ref D2D1_POINT_2U destPoint, ID2D1RenderTarget renderTarget, D2D1_RECT_U srcRect);
        new HRESULT CopyFromMemory(ref D2D1_RECT_U dstRect, IntPtr srcData, uint pitch);
        #endregion
